...
namespace Discord.SlashCommands
{
    ...
    public static class DefaultReaders
    {
        ...
        public static object PrimitiveReader (ISlashCommandContext ctx, SocketSlashCommandDataOption parameter, IServiceProvider services)
        {
        ...
        public static object UserReader (ISlashCommandContext ctx, SocketSlashCommandDataOption parameter, IServiceProvider services)
        {
        ...
        /// <exception cref="ArgumentException">Provided parameter cannot be parsed with the provided type reader</exception>
        public static object RoleReader (ISlashCommandContext ctx, SocketSlashCommandDataOption parameter, IServiceProvider services)
        {
            if (ulong.TryParse(parameter.Value.ToString(), out var id))
            {
                if (ctx.Guild != null)
        ...
        /// <exception cref="ArgumentException">Provided parameter cannot be parsed with the provided type reader</exception>
        public static object ChannelReader (ISlashCommandContext ctx, SocketSlashCommandDataOption parameter, IServiceProvider services)
        {
            if (ulong.TryParse(parameter.Value.ToString(), out var id))
            {
                if (ctx.Guild != null)
        ...
        /// <exception cref="ArgumentException">Provided parameter cannot be parsed with the provided type reader</exception>
        public static object MentionableReader (ISlashCommandContext ctx, SocketSlashCommandDataOption parameter, IServiceProvider services)
        {
            if (ulong.TryParse(parameter.Value.ToString(), out var id))
            {
                if (ctx.Guild == null)
        ...
        internal static void CreateDefaultTypeReaders (IDictionary<ApplicationCommandOptionType, Func<ISlashCommandContext, SocketSlashCommandDataOption,
