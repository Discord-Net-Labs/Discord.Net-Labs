...
namespace Discord.Interactions
{
    ...
    public abstract class ParameterPreconditionAttribute : Attribute
    {
        ...
        public abstract Task<PreconditionResult> CheckRequirementsAsync (IInteractionCommandContext context, IParameterInfo parameterInfo, IServiceProvider services);
    }
}
