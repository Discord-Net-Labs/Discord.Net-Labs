...
namespace Discord.Rest
{
    ...
    public class RestTextChannel : RestGuildChannel, IRestMessageChannel, ITextChannel
    {
        ...
        public Task<RestUserMessage> SendMessageAsync(string text = null, bool isTTS = false, Embed embed = null, Embed[] embeds = null, RequestOptions options = null, AllowedMentions allowedMentions = null, MessageReference messageReference = null, MessageComponent component = null, ISticker[] stickers = null)
            => ChannelHelper.SendMessageAsync(this, Discord, text, isTTS, embed, embeds, allowedMentions, messageReference, component, stickers, options);
        ...
        /// <inheritdoc />
        async Task<IUserMessage> IMessageChannel.SendMessageAsync(string text, bool isTTS, Embed embed, Embed[] embeds, RequestOptions options, AllowedMentions allowedMentions, MessageReference messageReference, MessageComponent component, ISticker[] stickers)
            => await SendMessageAsync(text, isTTS, embed, embeds, options, allowedMentions, messageReference, component, stickers).ConfigureAwait(false);
        #endregion
