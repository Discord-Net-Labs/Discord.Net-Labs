...
namespace Discord
{
  ...
  {
    public static IReadOnlyDictionary<string, string> NameEmojis { get; } = new Dictionary<string, string>
    {
        [",:("] = "\uD83D\uDE13",
      [",:)"] = "\uD83D\uDE05",
      [",:-("] = "\uD83D\uDE13",
    ...
    private static IReadOnlyDictionary<string, string> _unicodeEmojis;
    public static IReadOnlyDictionary<string, string> UnicodeEmojis
    {
        get
        {
            _unicodeEmojis ??= NameEmojis
               .GroupBy(e => e.Value, (_, xg) => xg.FirstOrDefault())
               .ToDictionary(kvp => kvp.Value, kvp => kvp.Key);
            return _unicodeEmojis;
        }

        private set
        {
            _unicodeEmojis = value;
        }
    }
  }
}
