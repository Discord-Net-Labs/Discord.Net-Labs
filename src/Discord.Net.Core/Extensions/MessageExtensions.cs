...
namespace Discord
{
    ...
    public static class MessageExtensions
    {
        ...
        /// </returns>
        public static async Task<IUserMessage> ReplyAsync(this IUserMessage msg, string text = null, bool isTTS = false, Embed embed = null, Embed[] embeds = null, AllowedMentions allowedMentions = null, RequestOptions options = null, MessageComponent components = null, ISticker[] stickers = null)
        {
            return await msg.Channel.SendMessageAsync(text, isTTS, embed, embeds, options, allowedMentions, new MessageReference(messageId: msg.Id), components, stickers).ConfigureAwait(false);
        }
    }
}
