...
namespace Discord
{
    internal sealed class MockedGroupChannel : IGroupChannel
    {
        ...
        public Task<IUserMessage> SendMessageAsync(string text = null, bool isTTS = false, Embed embed = null, Embed[] embeds = null, RequestOptions options = null, AllowedMentions allowedMentions = null, MessageReference messageReference = null, MessageComponent component = null, ISticker[] stickers = null)
        {
            throw new NotImplementedException();
        }
