...
namespace Discord
{
    internal sealed class MockedTextChannel : ITextChannel
    {
        ...
        public Task<IUserMessage> SendMessageAsync(string text = null, bool isTTS = false, Embed embed = null, RequestOptions options = null, AllowedMentions allowedMentions = null, MessageReference messageReference = null, MessageComponent component = null, ISticker[] stickers = null, bool ephemeral = false)
        {
            throw new NotImplementedException();
        }
